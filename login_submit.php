<?php
    ...
    $user_authentication_query="select id,email from project_04_users where email='$email' and password='$password'";
    $user_authentication_result=mysqli_query($con,$user_authentication_query) or die(mysqli_error($con));
    $rows_fetched=mysqli_num_rows($user_authentication_result);
    if($rows_fetched==0){
        ?>
        <script>
            window.alert("El correo electrónico o la contraseña es incorrecta");
        </script>
